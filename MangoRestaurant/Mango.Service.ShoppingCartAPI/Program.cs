...
builder.Services.AddControllers();
var serviceSection = builder.Configuration.GetSection("ServiceUrls");
builder.Services.AddHttpClient<ICouponRepository, 
    CouponRepository>(u=>u.BaseAddress= new Uri(serviceSection["CouponAPI"]));
